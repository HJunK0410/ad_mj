...
TRAIN_IMAGE_DIR="/home/user/hyunjun/AD/data/save/train_10/images"
TRAIN_LABEL_DIR="/home/user/hyunjun/AD/data/save/train_10/labels"
VAL_IMAGE_DIR="/home/user/hyunjun/AD/data/images/val"
VAL_LABEL_DIR="/home/user/hyunjun/AD/data/labels/val"
OUTPUT_DIR="./outputs/new_sjpm_10/"
BATCH_SIZE=4
EPOCHS=300
NUM_WORKERS=4
...
RUNTIME_YOLO_ROOT="/tmp/detr_yolo_split_${USER}_$$"
...
# Continuity Loss 설정
# `new_sjpm` 결과 기준 mAP50-95 상위 10개 조합만 실행
TARGET_COMBINATIONS=(
    "0.06 0.20 0.20"
    "0.04 0.10 0.30"
    "0.02 0.08 0.30"
...
echo "============================================================"
echo "DETR 선택 조합 실행 시작 (Continuity Loss + Norm Mask Bbox Coef)"
echo "============================================================"
...
for COMBINATION in "${TARGET_COMBINATIONS[@]}"; do
    read -r LAMBDA_CONT_2D LAMBDA_CONT_1D NORM_MASK_BBOX_COEF <<< "${COMBINATION}"
