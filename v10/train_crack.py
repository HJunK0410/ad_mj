#!/usr/bin/env python3
"""
crack-seg 데이터셋에 대한 YOLOv10 Detection 학습 스크립트
- baseline: 순수 YOLO (NPP loss 없음)
- best: 기존 실험에서 가장 좋았던 NPP loss 하이퍼파라미터 적용
  (l2d=0.08, l1d=0.0, mask=0.1, fpn=16,19,22 / mAP50-95=0.42937)
"""
...
# train_npp_l2d0.08_l1d0.0_mask0.1_fpn16_19_22 -> mAP50-95=0.42937
# ============================================================
BEST_HP = {
    'npp_lambda_2d': 0.08,
    'npp_lambda_1d': 0.0,
    'npp_bbox_mask_weight': 0.1,
