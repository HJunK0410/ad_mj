#!/usr/bin/env python3
"""
Crack-seg 데이터셋에 대해 학습된 모델들의 test 데이터셋 평가 스크립트 (v11)
- Baseline: crack_baseline
- NPP Best: crack_npp_l2d0.02_l1d0.08_mask0.2_fpn16_19_22
"""
...
EXPERIMENTS = [
    {
        'name': 'crack_baseline',
        'description': 'Baseline (순수 YOLOv11m, NPP loss 비활성)'
    },
    {
        'name': 'crack_npp_l2d0.02_l1d0.08_mask0.2_fpn16_19_22',
        'description': 'NPP Best (l2d=0.02, l1d=0.08, mask=0.2)'
    }
]
...
def main():
    ...
    print("=" * 60)
    print("Crack-seg Test 데이터셋 평가 (v11: Baseline + NPP Best)")
    print("=" * 60)
