#!/usr/bin/env python3
"""
crack-seg 데이터셋에 대한 YOLOv8 Detection 학습 스크립트 (차분 로스)
- baseline: 순수 YOLO (차분 loss 없음)
- best: 기존 실험에서 가장 좋았던 차분 loss 하이퍼파라미터 적용
  (alpha=0.0, beta=0.5, fpn=15,18,21 / mAP50-95=0.45591)
"""
...
# train_diff_alpha0.0_beta0.5_fpn15_18_21 -> mAP50-95=0.45591
# ============================================================
BEST_HP_DIFF = {
    'diff_alpha': 0.0,
    'diff_beta': 0.5,
